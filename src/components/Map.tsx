        ...
        wrap.innerHTML = `
          ...
          <div style="padding: 14px; position: relative;">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px; padding-right:24px;">
              ...
              <button data-action="detail" style="border:0; background:transparent; font-size:11px; color:#2563eb; cursor:pointer; font-weight:600; padding:0;">
                상세보기 ❯
              </button>
            </div>

            <div style="margin-bottom:10px;">
              <div style="font-size:17px; font-weight:800; color:#1a1a1a; margin-bottom:2px; letter-spacing:-0.5px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                ${cafe.name}
              </div>
            ...
            <div style="display:flex; gap:6px;">
              <button data-action="route" class="route-btn"
                style="flex:1; border:1px solid #e2e8f0; background:#fff; color:#475569; padding:10px; border-radius:8px; cursor:pointer; font-size:12px; font-weight:700; display:flex; align-items:center; justify-content:center; gap:4px;">
                🚙 길찾기
              </button>
              <button id="fav-${cafe.id}" class="fav-btn"
                ...
                <span style="font-size:14px; color:${isFav ? "#3c1e1e" : "transparent"}; -webkit-text-stroke: 1px #3c1e1e;">
                  ${isFav ? "★" : "★"}
                </span>
                ${isFav ? "저장됨" : "즐겨찾기"}
              </button>
